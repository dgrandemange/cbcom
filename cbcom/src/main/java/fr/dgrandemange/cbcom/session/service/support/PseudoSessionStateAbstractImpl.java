...
public abstract class PseudoSessionStateAbstractImpl implements
	 ...
	 * 
	 * @see
	 * fr.dgrandemange.cbcom.session.service.IPseudoSessionState#init(org.jpos
	 ...
	 * 
	 * @see
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduCNReceived(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	 ...
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduACEmitted(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	...
	/* (non-Javadoc)
	 * @see fr.dgrandemange.cbcom.session.service.IPseudoSessionState#onIpduACReceived(fr.dgrandemange.cbcom.session.model.PseudoSessionContext)
	 */
	...
	/* (non-Javadoc)
	 * @see fr.dgrandemange.cbcom.session.service.IPseudoSessionState#onIpduCNEmitted(fr.dgrandemange.cbcom.session.model.PseudoSessionContext)
	 */
	 ...
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduDEReceived(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	 ...
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduDEEmitted(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	 ...
	 * 
	 * @see
	 * fr.dgrandemange.cbcom.session.service.IPseudoSessionState#onIpduDEToSend
	 * (fr.dgrandemange.cbcom.session.model.PseudoSessionContext)
	 */
	 ...
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduABReceived(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	 ...
	 * fr.dgrandemange.cbcom.session.server.service.support.IPseudoSessionState2
	 * #
	 * onIpduABEmitted(fr.dgrandemange.cbcom.session.model.PseudoSessionContext
	 * )
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @seefr.dgrandemange.cbcom.session.server.service.IPseudoSessionState#
	 ...
	 * (non-Javadoc)
	 * 
	 * @seefr.dgrandemange.cbcom.session.service.IPseudoSessionState#
	 * onInvalidIpduReceived
	 * (fr.dgrandemange.cbcom.session.model.PseudoSessionContext,
	 * fr.dgrandemange.cbcom.exception.CBCOMBadIPDUException)
	 */
	public void onInvalidIpduReceived(PseudoSessionContext ctx,
	...
	protected void onInvalidIpduReceived(PseudoSessionContext ctx, int pv01) {
		...
		// Change session state to final state
		ctx.setSessionState(ctx.getStateFactory().getFinalState());
	}
	...
	protected void emitIpduAB(PseudoSessionContext ctx, int pv01) {
		try {
			...
			String mesg = String.format("ctxId=%d, code=0x%x [%s<-%s]",
					ctx.getId(), pv01, state, transition);
	...
	protected void cancelAndReplaceScheduledTimerTask(PseudoSessionContext ctx,
		...
		ScheduledThreadPoolExecutor exec = ctx
				.getPseudoSessionTimerTasksExecutorProvider().provide(
						ScheduledThreadPoolExecutor.class);

		if (exec != null) {
			ctx.setTaskFuture(exec.schedule(runnable, timerValue, timeUnit));
		} else {
			// Unable tp proceed
			emitIpduAB(ctx, 0x04);
		}
